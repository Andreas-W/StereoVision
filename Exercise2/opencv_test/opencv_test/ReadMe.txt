========================================================================
    KONSOLENANWENDUNG: opencv_test-Projektübersicht
========================================================================

Diese opencv_test-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre opencv_test-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen opencv_test.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
